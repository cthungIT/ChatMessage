...
- (UIView *)editorContentView
{
    if (!_editorContentView)
    {
        ...
        NSDictionary *metrics = @{@"left" : @(self.contentInset.left),
                                  @"right" : @100/*@(self.contentInset.right)*/
                                  };
        
        [_editorContentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-(left)-[leftButton(100)]-(left)-[label(>=0)]-(right)-[rightButton(100)]-(<=right)-|" options:0 metrics:metrics views:views]];
